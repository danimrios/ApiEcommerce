    ...
    if (!appContext.Products.Any())
    {
      appContext.Products.AddRange(
        new Product
        {
          ...
          Descripton = "Camiseta de algodón 100%",
          Price = 25.99m,
          SKU = "PROD-001-CAM-M",
          Stock = 50,
          CategoryId = 1,
        ...
        new Product
        {
          ...
          Descripton = "Teléfono inteligente con 128GB",
          Price = 599.99m,
        ...
        new Product
        {
          ...
          Descripton = "Pelota oficial FIFA",
          Price = 45.00m,
        ...
        new Product
        {
          ...
          Descripton = "Lámpara LED regulable",
          Price = 89.99m,
        ...
        {
          Name = "El Quijote",
          Descripton = "Novela clásica de Cervantes",
          Price = 19.99m,
        ...
        {
          Name = "Jeans Clásicos",
          Descripton = "Pantalones vaqueros azules",
          Price = 79.99m,
        ...
        {
          Name = "Tablet Pro",
          Descripton = "Tablet 10.5 pulgadas con stylus incluido",
          Price = 459.99m,
        ...
        new Product
        {
          ...
          Descripton = "Zapatillas deportivas para correr",
          Price = 129.99m,
        ...
        new Product
        {
          ...
          Descripton = "Cafetera automática con molinillo integrado",
          Price = 299.99m,
        ...
        new Product
        {
          ...
          Descripton = "Guía completa de programación en C# y .NET",
          Price = 49.99m,
        ...
        new Product
        {
          ...
          Descripton = "Chaqueta impermeable para actividades al aire libre",
          Price = 149.99m,
        ...
        new Product
        {
          ...
          Descripton = "Auriculares inalámbricos con cancelación de ruido",
          Price = 189.99m,
